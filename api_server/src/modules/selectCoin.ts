...
export const selectCoin = (changeDue: number, machineCoins: coins, coinsDispensed: coins): number => {
    ...
    // 1 dollar
    if(changeDue >= 100 && machineCoins.dollar1 > 0){
        changeDue -= 100;
    ...
    // 50 cents
    if(changeDue >= 50 && machineCoins.cent50 > 0){
        changeDue -= 50;
    ...
    // 20 cents
    if(changeDue >= 20 && machineCoins.cent20 > 0){
        changeDue -= 20;
    ...
    // 10 cents
    if(changeDue >= 10 && machineCoins.cent10 > 0){
        changeDue -= 10;
    ...
    // 5 cents
    if(changeDue >= 5 && machineCoins.cent5 > 0){
        changeDue -= 5;
    ...
    // 2 cents
    if(changeDue >= 2 && machineCoins.cent2 > 0){
        changeDue -= 2;
